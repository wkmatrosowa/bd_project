...
class AlbumTable(SQLTable):
    ...
    __UPDATE_SQL = "UPDATE album SET albumname = %s, year = %s, genre = %s, id_performer = %s WHERE id = %s"
    ...
    def update(self, albumname: str = "", year: str = "", genre: str = "", id_performer: str = "", id: str = ""):
        mysql_adapter.execute_with_params(query=self.__UPDATE_SQL, params=(albumname, year, genre, id_performer, id))
